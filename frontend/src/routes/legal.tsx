	...
	return (
		<PageContainer>
			...
			<Main className={text['aux/sm/regular']}>
				...
				<h1>Tamashii Phase 0: Testnet Legal Disclaimer</h1>
				<p>
					The Tamashii Testnet blockchain software (the “<b>Testnet</b>
					”) is a screened, centralized blockchain testing environment provided
					as a free service by Nous Research Inc. (“
					<b>Nous</b>”) on behalf of the Tamashii Foundation for the purpose of
				...
				<p>
					...
					Tamashii Foundation, or others, are provided for non-commercial,
				...
				<p>
					...
					digital protocol tokens made available by Nous or the Tamashii
				...
				<p>
					...
					and the Services, including but not limited to, Nous, the Tamashii
				...
				<p>
					The TamashiiFoundation GitHub, the Tamashii.Network documents site, and
